...
import { createQuestion, listQuestions } from '@/server/services/question.service';
...
export async function GET(request: Request) {
  try {
    ...
    const questions = await listQuestions({ level: level ?? undefined, chapterId, subtopicId });
