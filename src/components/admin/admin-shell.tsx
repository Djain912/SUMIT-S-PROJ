...
import { LayoutDashboard, BookOpen, FileText, ListChecks, Flag, ShieldCheck, Menu, X, LogOut, MessageSquare, Bot, Globe, ThumbsUp, Newspaper, Users, LineChart, Ticket, Sparkles } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Key Takeaways', href: '/admin/summary', icon: Sparkles },
